...
.login-logo { width: 64px; height: 64px; border-radius: 50%; margin: 0 auto 24px; display: block; }
.login-title { font-size: 22px; font-weight: 700; text-align: center; color: #111827; margin-bottom: 4px; }
.login-sub { font-size: 14px; color: #6b7280; text-align: center; margin-bottom: 32px; }
.login-label { font-size: 13px; font-weight: 500; color: #374151; margin-bottom: 6px; display: block; }
.login-input {
    width: 100%; padding: 10px 14px; border: 1px solid #d1d5db; border-radius: 10px;
    font-size: 14px; font-family: 'Inter', sans-serif; margin-bottom: 16px; outline: none;
    transition: border 0.2s;
}
.login-input:focus { border-color: #6366f1; box-shadow: 0 0 0 3px rgba(99,102,241,0.1); }
.login-btn {
    width: 100%; padding: 11px; background: #111827; color: #fff; border: none; border-radius: 10px;
...
.login-error { color: #dc2626; font-size: 13px; text-align: center; margin-bottom: 12px; }
.login-footer { text-align: center; margin-top: 24px; font-size: 12px; color: #9ca3af; }
.login-link { text-align: right; margin-bottom: 20px; }
.login-link a { font-size: 13px; color: #6366f1; text-decoration: none; }
.spinner-btn { border: 2px solid #fff; border-top: 2px solid transparent; border-radius: 50%; width: 14px; height: 14px; animation: spin .7s linear infinite; display: none; }
.spinner-btn.active { display: block; }
