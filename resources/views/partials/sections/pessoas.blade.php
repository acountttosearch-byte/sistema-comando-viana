<div id="section-pessoas" class="section">
    ...
    <div class="filters">
        <div class="search-filter"><i class='bx bx-search'></i><input type="text" id="f-pes-busca" placeholder="Buscar por nome, BI ou alcunha..."></div>
        ...
        <select id="f-pes-nacionalidade" onchange="loadPessoas()"><option value="">Nacionalidade</option><option value="Angolana">Angolana</option><option value="Portuguesa">Portuguesa</option><option value="Brasileira">Brasileira</option><option value="Outra">Outra</option></select>
        <button class="btn-ghost" onclick="loadPessoas()"><i class='bx bx-search'></i></button>
    </div>
    <div class="tbl">
